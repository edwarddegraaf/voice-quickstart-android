...
public class VoiceActivity extends AppCompatActivity {
    ...
    FileCapturerAudioDevice customAudioDevice;
    ...
    private DialogInterface.OnClickListener callClickListener() {
        return (dialog, which) -> {
            ...
            params.put("answer_on_bridge", "true");
            ConnectOptions connectOptions = new ConnectOptions.Builder(accessToken)
                    .params(params)
                    .build();
            customAudioDevice = new FileCapturerAudioDevice(getApplicationContext());
    ...
    private View.OnClickListener inputSwitchActionFabClickListener() {
        return v-> {
            ...
            customAudioDevice.switchInput(!customAudioDevice.isMusicPlaying());
        };
    }
    ...
    private void retrieveAccessToken() {
        VoiceActivity.this.accessToken = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCIsImN0eSI6InR3aWxpby1mcGE7dj0xIn0..0IgSHJLEfEuutifzW8sUD0QXCjxtqwj0uETeOhTEhJ8";
        /*
        Ion.with(this).load(TWILIO_ACCESS_TOKEN_SERVER_URL + "?identity=" + identity)
                ...
                .setCallback((e, accessToken) -> {
                    if (e == null) {
                        ...
                        VoiceActivity.this.accessToken = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCIsImN0eSI6InR3aWxpby1mcGE7dj0xIn0..xLf6nWv2q7mOFgR_wr1uhncs_8rjdgvKNwGdR7OVwxw";
